...
const TableStudent = () => {
    const { handleDelete, updateStudent, currentStudents, nextPage, prevPage } = useStudentList();
    console.log("render");

    return (
        <div className='container-fluid px-5 py-3'>
            <NavStudent />
            <div className='table-responsive tbl-student'>
                            ...
                            <tr className='table-primary' key={estudiante.id}>
                                ...
                                <td>
                                    <div className='d-flex justify-content-center gap-2'>
                                        ...
                                        <Link to='/infoStudent' className='btn btn-primary btn-sm btn-tooltip' data-title='Mas info'>
            ...
            <div className='d-flex justify-content-end align-items-center' style={{ height: "22px" }}>
                <button className='btn d-flex align-items-center' onClick={prevPage}>
                    <i className="bi bi-arrow-left"></i>
                </button>
                <button className='btn d-flex align-items-center' onClick={nextPage}>
